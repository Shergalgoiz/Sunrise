...
<head>
    <title>Sunrise foreign Language</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 d-none d-md-flex flex-wrap justify-content-center justify-content-lg-start mb-3 mb-lg-0">
                            <div class="header-bar-email d-flex align-items-center">
                                <i class="fa fa-envelope"></i><a href="#">Mặt Trời Trổi Dậy @gmail.com</a>
                            </div><!-- .header-bar-email -->
                            <div class="header-bar-text lg-flex align-items-center">
                                <p><i class="fa fa-phone"></i>0369981140 - 0973587453</p>
                            </div><!-- .header-bar-text -->
                        </div><!-- .col -->
                        <div class="col-12 col-lg-6 d-flex flex-wrap justify-content-center justify-content-lg-end align-items-center">
                            <div class="header-bar-menu">
                                <ul class="flex justify-content-center align-items-center py-2 pt-md-0">
                                    <li><a href="https://www.facebook.com/the.sunrise.509"><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
                                </ul>
                            </div><!-- .header-bar-menu -->
                        </div><!-- .col -->
                    </div><!-- .row -->
                    ...
                    <div class="row">
                        <div class="col-9 col-lg-3">
                            <div class="site-branding">
                                <h1 class="site-title"><a href="index.php" rel="home">Sunrise <span>Foreign Center</span></a></h1>
                            </div><!-- .site-branding -->
                        </div><!-- .col -->
